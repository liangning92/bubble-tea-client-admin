...
export default function StoreLayout() {
  ...
  const allMenuItems = [
    ...
    { path: '/product', label: t('nav.products'), icon: '🧋', module: 'inventory' },
    { path: '/profit', label: t('nav.revenue'), icon: '💰', module: ['revenue_flow', 'profit_detail', 'expense_claim'] },
    { path: '/staff', label: t('nav.staff'), icon: '👥', module: ['staff_manage', 'hygiene'] },
    { path: '/marketing', label: t('nav.marketing'), icon: '🚀', module: 'staff_manage' },
