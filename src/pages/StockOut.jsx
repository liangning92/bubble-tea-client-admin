    ...
    <div className="space-y-6 animate-soft text-slate-900 pb-24">
      {!hideHeader && (
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 px-4">
          <div className="space-y-4.5">
            <h3 className="text-xl font-black text-slate-900 tracking-tighter uppercase ">{t('stockOutHub')}</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
           <div className="card-premium border-slate-50 !p-6 space-y-6 transition-all hover:border-slate-300 shadow-sm relative overflow-hidden !rounded-[48px] bg-white group">
              ...
              {!hideHeader && (
                <h4 className="text-base font-black text-slate-900 uppercase tracking-tighter  border-b border-slate-50 pb-6 relative z-10 flex items-center gap-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10">
                 ...
                 <div className="space-y-4">
                    ...
                    <div className="flex overflow-hidden rounded-[24px] border border-slate-100 shadow-sm bg-slate-50/50">
                       <input type="number" className="input-premium flex-1 !p-6 font-black text-slate-900 text-lg border-none shadow-none bg-transparent focus:!bg-white " value={quantity} onChange={e => setQuantity(e.target.value)} />
              ...
              <button 
                ...
                className="w-full btn-premium active !bg-slate-900 !text-white !h-14 border-none shadow-3xl shadow-slate-900/20 text-[18px] font-black uppercase tracking-[0.2em] relative z-10 !scale-100 hover:scale-[1.02] active:scale-95 transition-all !rounded-2xl  "
              >
        ...
        <div className="space-y-6">
           <div className="card-premium border-slate-50 bg-white !p-0 overflow-hidden shadow-sm hover:border-slate-300 transition-all !rounded-[48px] h-full">
              <div className="p-6 border-b border-slate-50 bg-slate-50/30 backdrop-blur-md flex justify-between items-center">
              ...
              <div className="divide-y divide-slate-50 max-h-[1000px] overflow-y-auto no-scrollbar font-sans">
                 {stockOutHistory.length === 0 ? (
                   ...
                   stockOutHistory.map(h => (
                      <div key={h.id} className="p-6 hover:bg-slate-50/80 transition-all group cursor-default relative overflow-hidden">
                         <div className="absolute top-0 right-0 p-8 opacity-5 text-xl font-black grayscale pointer-events-none  uppercase">DISPOSE</div>
