  ...
  return (
    <div className="space-y-5 animate-soft text-slate-900 pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
         <div className="card-premium !p-6 border-slate-50 bg-white !rounded-[40px] shadow-sm relative overflow-hidden group">
         ...
         <div className="card-premium !p-6 border-orange-50 bg-orange-50/10 !rounded-[40px] shadow-sm relative overflow-hidden group">
            <div className="absolute top-0 right-0 p-8 text-4xl opacity-10 group-hover:scale-110 transition-transform">🔍</div>
         ...
         <div className="card-premium !p-6 border-indigo-50 bg-indigo-50/10 !rounded-[40px] shadow-sm relative overflow-hidden group">
            <div className="absolute top-0 right-0 p-8 text-4xl opacity-10 group-hover:scale-110 transition-transform">🧠</div>
            ...
            <table className="w-full text-left">
               <thead>
                  <tr className="border-b border-slate-50">
                     <th className="p-4 text-[11px] font-black text-slate-300 uppercase tracking-widest">{t('materialDetail')}</th>
                     <th className="p-4 text-[11px] font-black text-slate-300 uppercase tracking-widest">{t('theoryVsActual')}</th>
                     <th className="p-4 text-[11px] font-black text-slate-300 uppercase tracking-widest">{t('anomalyType')}</th>
                     <th className="p-4 text-[11px] font-black text-slate-300 uppercase tracking-widest">{t('riskLevel')}</th>
                     <th className="p-4 text-[11px] font-black text-slate-300 uppercase tracking-widest text-right">{t('foundTime')}</th>
                  </tr>
               </thead>
               <tbody className="divide-y divide-slate-50">
                  {anomalies.map(item => (
                     <tr key={item.id} className="hover:bg-slate-50/50 transition-all select-none group">
                        ...
                        <td className="p-4 uppercase font-black text-slate-500 text-[12px] tracking-widest">
                        ...
                        <td className="p-4 text-right font-black text-slate-300 text-[13px] uppercase tracking-tight group-hover:text-slate-900 transition-colors">
                           {item.date}
                        </td>
                     </tr>
                  ))}
